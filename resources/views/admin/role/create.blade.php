...
<div class="page-title">
	<div class="row">
		<div class="col-12 col-md-6 order-md-1 order-last">
			...
			<p class="text-subtitle text-muted">Silahkan isi data role yang akan ditambahkan</p>
		</div>
	</div>
</div>
<div class="card">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="name" placeholder="Enter nama role" name="role_name" value="{{ old('role_name') }}" required>
						</div>
						<div class="form-group">
