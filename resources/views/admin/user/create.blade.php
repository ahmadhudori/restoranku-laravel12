...
<div class="page-title">
	<div class="row">
		<div class="col-12 col-md-6 order-md-1 order-last">
			...
			<p class="text-subtitle text-muted">Silahkan isi data karyawan yang akan ditambahkan</p>
		</div>
	</div>
</div>
<div class="card">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="fullname" placeholder="Enter nama karyawan" name="fullname" value="{{ old('fullname') }}" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="phone" placeholder="Enter no telpon" name="phone" value="{{ old('phone') }}" required>
						</div>
						<div class="form-group">
