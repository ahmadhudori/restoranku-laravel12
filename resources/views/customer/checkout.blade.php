...
<div class="container-fluid page-header py-5">
	...
	<ol class="breadcrumb justify-content-center mb-0">
		<li class="breadcrumb-item active text-primary">Silakan isi detail pembayaran</li>
	</ol>
</div>
					...
					<div class="row">
						<div class="col-md-12 col-lg-4">
							<div class="form-item w-100">
								...
								<input type="text" class="form-control" name="fullname" placeholder="Masukan Nama Lengkap Anda" required>
							</div>
						</div>
						<div class="col-md-12 col-lg-4">
							<div class="form-item w-100">
								<label class="form-label my-3">Nomor WhatsApp<sup>*</sup></label>
								<input type="text" class="form-control" name="nomorWhatsapp" placeholder="Masukan Nomor WhatsApp Anda" required>
							</div>
						</div>
						<div class="col-md-12 col-lg-4">
							<div class="form-item w-100">
								<label class="form-label my-3">Nomor Meja<sup>*</sup></label>
								<input type="text" class="form-control" value="{{ $tableNumber ?? 'Nomor meja belum diisi' }}" disabled required>
							</div>
						</div>
					</div>   
					<br>
									...
									<tr>
										<th scope="row">
											<div class="d-flex align-items-center mt-2">
												<img src="{{ asset('img_item_upload/' . $item['image']) }}" onerror="this.onerror=null;this.src='{{ $item['image'] }}';" class="img-fluid rounded-circle" style="width: 100px; height: 90px; object-fit: cover;" alt="">
											</div>
										</th>
						...
						<div class="col-lg-12">
							<div class="bg-light rounded">
								...
								<div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
									...
									<h5 class="mb-0 pe-4">RRp.{{ number_format($totalAmount, 0, ',', '.') }}</h5>
								</div>
